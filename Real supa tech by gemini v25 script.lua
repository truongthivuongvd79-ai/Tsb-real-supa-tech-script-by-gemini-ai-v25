local a,b,c,d=game:GetService("Players"),game:GetService("Workspace"),game:GetService("RunService"),game:GetService("CoreGui")local e=a.LocalPlayer;local f,h,i=true,false,false;local j={}local k,l,m,n=1.2,4.5,3.8,15;local o=Instance.new("ScreenGui")o.Name="TSB_CustomGUI_V28"pcall(function()o.Parent=d end)if not o.Parent then o.Parent=e:WaitForChild("PlayerGui")end;local p=Instance.new("Frame")p.Size=UDim2.new(0,165,0,370)p.Position=UDim2.new(0.05,0,0.15,0)p.BackgroundColor3=Color3.fromRGB(22,22,28)p.BorderSizePixel=0;p.Active=true;p.Draggable=true;p.Parent=o;local q=Instance.new("UICorner")q.CornerRadius=UDim.new(0,10)q.Parent=p;local r=Instance.new("UIStroke")r.Color=Color3.fromRGB(0,162,255)r.Thickness=1.5;r.Parent=p;local s=Instance.new("ImageButton")s.Size=UDim2.new(0,42,0,42)s.Position=UDim2.new(0.02,0,0.4,0)s.BackgroundColor3=Color3.fromRGB(15,15,20)s.Image="rbxassetid://13805952445"s.Visible=false;s.Active=true;s.Draggable=true;s.Parent=o;local t=Instance.new("UICorner")t.CornerRadius=UDim.new(1,0)t.Parent=s;local u=Instance.new("UIStroke")u.Color=Color3.fromRGB(0,220,255)u.Thickness=2.5;u.Parent=s;local v=Instance.new("TextLabel")v.Size=UDim2.new(0,120,0,20)v.Position=UDim2.new(0.05,0,0.02,0)v.BackgroundTransparency=1;v.Text="By Newi (V1.28)"v.TextColor3=Color3.fromRGB(0,220,255)v.TextXAlignment=Enum.TextXAlignment.Left;v.TextScaled=true;v.Font=Enum.Font.SourceSansBold;v.Parent=p;local w=Instance.new("TextButton")w.Size=UDim2.new(0,18,0,18)w.Position=UDim2.new(0.85,0,0.02,0)w.BackgroundColor3=Color3.fromRGB(220,50,50)w.Text="-"w.TextColor3=Color3.fromRGB(255,255,255)w.TextScaled=true;w.Font=Enum.Font.SourceSansBold;w.Parent=p;local x=Instance.new("UICorner")x.CornerRadius=UDim.new(0,4)x.Parent=w;w.MouseButton1Click:Connect(function()p.Visible=false;s.Visible=true end)s.MouseButton1Click:Connect(function()p.Visible=true;s.Visible=false end)local y=Instance.new("ScrollingFrame")y.Size=UDim2.new(0.92,0,0.90,0)y.Position=UDim2.new(0.04,0,0.08,0)y.BackgroundTransparency=1;y.BorderSizePixel=0;y.ScrollBarThickness=3;y.CanvasSize=UDim2.new(0,0,0,450)y.Parent=p;local z=Instance.new("UIListLayout")z.Parent=y;z.SortOrder=Enum.SortOrder.LayoutOrder;z.Padding=UDim.new(0,4)local function A(B,C,D)local E=Instance.new("Frame")E.Size=UDim2.new(1,0,0,22)E.BackgroundTransparency=1;E.LayoutOrder=D;E.Parent=y;local F=Instance.new("TextLabel")F.Size=UDim2.new(0.56,-4,1,0)F.BackgroundColor3=Color3.fromRGB(32,32,42)F.Text=B;F.TextColor3=Color3.fromRGB(240,240,240)F.TextScaled=true;F.Font=Enum.Font.SourceSans;F.Parent=E;local G=Instance.new("UICorner")G.CornerRadius=UDim.new(0,4)G.Parent=F;local H=Instance.new("TextBox")H.Size=UDim2.new(0.42,0,1,0)H.Position=UDim2.new(0.58,0,0,0)H.BackgroundColor3=Color3.fromRGB(15,15,20)H.Text=tostring(C)H.TextColor3=Color3.fromRGB(0,220,255)H.TextScaled=true;H.Font=Enum.Font.SourceSansBold;H.Parent=E;local I=Instance.new("UICorner")I.CornerRadius=UDim.new(0,4)I.Parent=H;return H end;local J=A("Top:",k,1)local K=A("Bottom:",l,2)local L=A("Diameter:",m,3)local M=A("Tilt:",n,4)J.FocusLost:Connect(function()local N=tonumber(J.Text)if N then k=math.clamp(N,0,50)else J.Text=tostring(k)end end)K.FocusLost:Connect(function()local N=tonumber(K.Text)if N then l=math.clamp(N,0,50)else K.Text=tostring(l)end end)L.FocusLost:Connect(function()local N=tonumber(L.Text)if N then m=math.clamp(N,0,100)else L.Text=tostring(m)end end)M.FocusLost:Connect(function()local N=tonumber(M.Text)if N then n=math.clamp(N,0,180)else M.Text=tostring(n)end end)

local function O(B,P,D,Q)
...
O("Headless/Korbl",h,7,function(U)h=U end)

local V=Instance.new("TextButton")V.Size=UDim2.new(1,0,0,24)V.BackgroundColor3=Color3.fromRGB(150,50,200)V.Text="Test Pillar"V.TextColor3=Color3.fromRGB(255,255,255)V.TextScaled=true;V.Font=Enum.Font.SourceSansBold;V.LayoutOrder=8;V.Parent=y;local W=Instance.new("UICorner")W.CornerRadius=UDim.new(0,4)W.Parent=V;V.MouseButton1Click:Connect(function()if not e.Character then return end;local X=e.Character:FindFirstChild("HumanoidRootPart")if not X then return end;local Y=math.max(0.1,k+l)local Z=math.max(0.1,m)local _=Instance.new("Part")_.Name="TSB_TestPillar"_.Shape=Enum.PartType.Cylinder;_.Size=Vector3.new(Y,Z,Z)_.Anchored=true;_.CanCollide=true;_.Transparency=0.35;_.BrickColor=BrickColor.new("Bright red")_.Material=Enum.Material.Neon;_.CFrame=X.CFrame*CFrame.Angles(math.rad(n),0,0)*CFrame.Angles(0,0,math.rad(90))_.Parent=b;task.delay(0.5,function()if _ and _.Parent then _:Destroy()end end)end)
