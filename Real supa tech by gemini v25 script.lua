...
local function O(B,P,D,Q)
    ...
    R.LayoutOrder=D;
    R.Parent=y;
    local S=Instance.new("UICorner")S.CornerRadius=UDim.new(0,5)S.Parent=R;
    local T=P;
...
-- CONFIG SECTION --
local cfgFrame=Instance.new("Frame")cfgFrame.Size=UDim2.new(1,0,0,26)cfgFrame.BackgroundTransparency=1;cfgFrame.LayoutOrder=9;cfgFrame.Parent=y;
...
local cfgCorner=Instance.new("UICorner")cfgCorner.CornerRadius=UDim.new(0,5)cfgCorner.Parent=cfgBox;

local btnFrame=Instance.new("Frame")btnFrame.Size=UDim2.new(1,0,0,26)btnFrame.BackgroundTransparency=1;btnFrame.LayoutOrder=10;btnFrame.Parent=y;
local saveBtn=Instance.new("TextButton")saveBtn.Size=UDim2.new(0.48,0,1,0)saveBtn.BackgroundColor3=Color3.fromRGB(0,140,220)saveBtn.Text="Save Config"saveBtn.TextColor3=Color3.fromRGB(255,255,255)saveBtn.TextScaled=true;saveBtn.Font=Enum.Font.SourceSansBold;saveBtn.Parent=btnFrame;
local saveCorner=Instance.new("UICorner")saveCorner.CornerRadius=UDim.new(0,5)saveCorner.Parent=saveBtn;

local loadBtn=Instance.new("TextButton")loadBtn.Size=UDim2.new(0.48,0,1,0)loadBtn.Position=UDim2.new(0.52,0,0,0)loadBtn.BackgroundColor3=Color3.fromRGB(40,160,80)loadBtn.Text="Load Config"loadBtn.TextColor3=Color3.fromRGB(255,255,255)loadBtn.TextScaled=true;loadBtn.Font=Enum.Font.SourceSansBold;loadBtn.Parent=btnFrame;
local loadCorner=Instance.new("UICorner")loadCorner.CornerRadius=UDim.new(0,5)loadCorner.Parent=loadBtn;
...
c.RenderStepped:Connect(function()
    ...
    if ae then 
        local targetCFrame = CFrame.lookAt(X.Position, Vector3.new(ae.Position.X, ae.Position.Y, ae.Position.Z))
        X.CFrame = X.CFrame:Lerp(targetCFrame, 0.3)
        if workspace.CurrentCamera then
            workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(CFrame.new(workspace.CurrentCamera.CFrame.Position, ae.Position), 0.3)
        end
    end 
end)
